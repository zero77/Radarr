...
class QualityDefinition extends Component {
  ...
  constructor(props, context) {
    ...
    this.state = {
      ...
      sliderPreferredSize: getSliderValue(props.preferredSize, (slider.max - 5))
    };
  }
  ...
  onSliderChange = ([sliderMinSize, sliderPreferredSize, sliderMaxSize]) => {
    ...
    this.props.onSizeChange({
      ...
      preferredSize: sliderPreferredSize === (slider.max - 5) ? null : roundNumber(Math.pow(sliderPreferredSize, 1.1)),
  ...
  onAfterSliderChange = () => {
    ...
    this.setState({
      ...
      sliderPreferredSize: getSliderValue(preferredSize, (slider.max - 5)) // fix
    });
  }
  ...
  onPreferredSizeChange = ({ value }) => {
    const preferredSize = value === (MAX - 5) ? null : getValue(value);
